...
> **Historical failure snapshot — superseded.** Project identifiers and provider error IDs are intentionally redacted; consult the current staging verification and release-readiness reports for present status.
